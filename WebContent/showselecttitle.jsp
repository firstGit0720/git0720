...
<html>
	...
	<body>
		...
		<div class="sidebar inner">
			...
			<div class="sb_box">
				<h3 class="title">
			<div class="position">当前位置：<a href="#" title="网站首页">网站首页</a> &gt; <a href=../news/ >新闻分类</a> > <a href=../news/news.php?lang=cn&class2=5 >新闻分类</a></div>
			<span>新闻分类</span>
			</h3>
				<div class="clear"></div>
				...
				<div class="active header-height" id="shownews" s>
				<ul>
				<% for(NewsInfo news : newslist) {%>
					<li><b><a href="selectNewsInfoByTitleServlet?news_title=<%=news.getNews_title() %>"><%=news.getNews_title() %></a></b></li>			
				<% } %>	
			</ul>
				</div>
